function I = milstein(W, n)
%MILSTEIN Simulates Levy area using the Milstein algorithm.
%   I = MILSTEIN(W,N) simulates the Levy area w.r.t. the increment of 
%   a Wiener process W with variance 1.
%   Uses the Milstein algorithm with cut-off parameter N.
%
...
%       I = diag(sqrt(q)) * milstein(W./sqrt(q),n) * diag(sqrt(q)).
%
